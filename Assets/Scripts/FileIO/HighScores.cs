...
public class HighScores : MonoBehaviour {
    ...
    public void LoadScoresFromFile()
    {
        ...
        while (fileReader.Peek() != 0 && scoreCount < scores.Length)
        {
            ...
            int readScore = -1; // Make a variable to put it in
            bool didParse = int.TryParse(fileLine, out readScore); // Try to parse it
            if (didParse)
            {
        ...
        // Now lets print the values of the scores we've read in
